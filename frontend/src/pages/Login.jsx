...
const Login = ({ onLogin }) => {
  ...
  const handleInstagramLogin = async () => {
    setLoading(true);
    try {
      // Use backend endpoint that will redirect to Instagram OAuth
      const backendAuthUrl = `${import.meta.env.VITE_API_URL}/auth/instagram/login`
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-purple-100">
            Connect your social media accounts to start managing your business
          </p>
        </div>
